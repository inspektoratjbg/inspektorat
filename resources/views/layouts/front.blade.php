...
<head>
    ...
    <meta property="og:title" content="Inspektorat Kabupaten Jombang" />
    <meta property="og:description" content="Inspektorat Kabupaten Jombang Bersama Mewujudkan Jombang Yang Berkarakter Dan Berdaya Saing." />
  ...
  <header class="header-global">
      <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
        <div class="container col-lg-12">
          <img alt="image" width="250px" src="{{ asset('front/logo inspektorat putih.png') }}">
          ...
          <div class="navbar-collapse collapse" id="navbar_global">
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
              <li class="nav-item dropdown">
                <a href="{{ route('front.home') }}" class="nav-link" role="button">
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
              ...
              <li class="nav-item d-none d-lg-block ml-lg-4">
                <a href="{{ route('front.admin') }}" target="_blank" class="btn btn-neutral btn-icon">
