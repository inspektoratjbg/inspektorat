...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.surat_keluar.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.surat_keluar.update", [$surat_keluar->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('tanggal_masuk') ? 'has-error' : '' }}">
                ...
                <input type="date" id="tanggal_surat" name="tanggal_surat" class="form-control" value="{{ old('tanggal_surat', isset($surat_keluar) ? $surat_keluar->tanggal_surat : '') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="hidden" id="created_by" name="created_by" class="form-control" value="{{ $surat_keluar->created_by }}" required>
            </div>
            <div>
