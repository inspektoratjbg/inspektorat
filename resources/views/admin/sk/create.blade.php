...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.sk.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.sk.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('lampiran') ? 'has-error' : '' }}">
                ...
                <input type="file" id="lampiran" name="lampiran[]" class="form-control" value="{{ old('lampiran', isset($sk) ? $sk->lampiran : '') }}" multiple required>
