...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.undangan.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.undangan.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group {{ $errors->has('lampiran') ? 'has-error' : '' }}">
                ...
                <input type="file" id="lampiran" name="lampiran[]" class="form-control" value="{{ old('lampiran', isset($undangan) ? $undangan->lampiran : '') }}" multiple required>
