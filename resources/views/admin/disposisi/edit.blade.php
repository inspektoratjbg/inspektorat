...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.disposisi.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.disposisi.update", [$disposisi->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="hidden" id="created_by" name="created_by" class="form-control" value="{{ $disposisi->created_by }}" required>
            </div>
            <div>
