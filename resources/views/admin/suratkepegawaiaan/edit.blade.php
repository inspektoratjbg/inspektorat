...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.suratkepegawaiaan.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.suratkepegawaiaan.update", [$suratkepegawaiaan->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
