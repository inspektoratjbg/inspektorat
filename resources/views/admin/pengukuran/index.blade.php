...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.perjanjian.title_singular') }} {{ trans('global.list') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                ...
                <tbody>
                    ...
                    @foreach($perjanjian as $key => $perjanjian)
                        <tr data-entry-id="{{ $perjanjian->id }}">
                            <td>
...
@can('users_manage')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.perjanjian.mass_destroy') }}",
