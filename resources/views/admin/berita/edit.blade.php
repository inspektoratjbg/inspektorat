        ...
        <form action="{{ route("admin.berita.update", [$berita->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('arsip_berita') ? 'has-error' : '' }}">
                <label for="arsip_berita">Arsip berita *
                    <span class="btn btn-info btn-xs select-all">{{ trans('global.select_all') }}</span>
                    <span class="btn btn-info btn-xs deselect-all">{{ trans('global.deselect_all') }}</span></label>
                <select name="arsip_berita[]" id="arsip_berita" class="form-control select2" multiple="multiple">
            ...
            <div class="form-group {{ $errors->has('tgl_publikasi') ? 'has-error' : '' }}">
                ...
                <input type="date" id="tgl_publikasi" name="tgl_publikasi" class="form-control" value="{{ old('tgl_publikasi', isset($berita) ? $berita->tgl_publikasi : '') }}" required>
