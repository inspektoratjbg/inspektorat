    ...
    <div class="container ">
        ...
        <table class="tabe">
                <tbody>
                            ...
                            <table width="100%">
                                <tr style="border:1px solid #fff;">
                                    ...
                                    <td style="border:1px solid #fff;" width="50%">
                                        1. Sekretaris<br>
                                        2. Irban Keuangan<br>
                                        3. Irban Pemerintahan<br>
                                        4. Irban Ekonomi Kesra
                                    </td>
                                    <td style="border:1px solid #fff;" width="50%">
                                        5. Irban Pembangunan<br>
                                        6. Ka Sub Bag Umum<br>
                                        7. Ka Sub Bag Perencana<br>
                                        8. Ka Sub Bag Evaluasi
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr style="padding:0px; vertical-align: text-top;" height="70%">
                        <td>
