...
(100,'pak gofur','2023-07-27-pak-gofur-08-03-49am-FOTO_2018_198008152009011010_lama.jpg','[\"pegawai\"]','[\"foto\"]','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','2023-07-27 08:03:49','2023-07-27 08:03:49'),
(101,'pak setiawan','2023-07-27-pak-setiawan-08-04-25am-FOTO_197405132001121003.JPG','[\"pegawai\"]','[\"foto\"]','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','2023-07-27 08:04:25','2023-07-27 08:04:25'),
(102,'pak inspektur abdu madjid','2023-07-27-pak-inspektur-abdu-madjid-08-04-50am-2023-04-04-foto-inspektur-abdul-madjid.jpg','[\"pegawai\"]','[\"foto\"]','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','2023-07-27 08:04:50','2023-07-27 08:04:50');
...
(1,'196701051992121001','ABDUL MADJID NINDYAGUNG, SH., M.Si.','1','15','15','<p>-<p>','[\"2023-07-27-pak-inspektur-abdu-madjid-08-04-50am-2023-04-04-foto-inspektur-abdul-madjid.jpg\"]','null','aktif','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','2023-09-07 15:10:04','2023-09-07 08:10:04'),
...
(4,'197011262002121006','AGUNG HARIADI, ST., MM','2','12','13','<p>-</p>','[\"2019-12-26-agung-hariadi-st-mm.jpg\"]','null','tidak aktif','Maulana Rizki','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','2023-07-27 14:54:45','2023-07-27 07:54:45'),
...
(7,'198002022010012026','IKE ROCHMANIAR, SE., ME.','4','7','11','<p>-</p>','[\"2019-12-26-ike-rochmaniar-se.jpg\"]','null','tidak aktif','Maulana Rizki','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','2023-07-27 14:53:39','2023-07-27 07:53:39'),
...
(88,'198008152009011010','ABDUL GHOFOR','7','16','8','<p>-</p>','[\"2023-07-27-pak-gofur-08-03-49am-FOTO_2018_198008152009011010_lama.jpg\"]','null','aktif','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','2023-07-27 08:13:00','2023-07-27 08:13:00'),
(89,'197405132001121003','SETIAWAN AFANDI, ST., MT','2','12','13','<p>-</p>','[\"2023-07-27-pak-setiawan-08-04-25am-FOTO_197405132001121003.JPG\"]','null','aktif','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','MOCHAMMAD AULYA RAHMAN, A.Md.Kom.','2023-07-27 08:14:12','2023-07-27 08:14:12');
...
/*Table structure for table `tb_wbs_audit` */

DROP TABLE IF EXISTS `tb_wbs_audit`;

CREATE TABLE `tb_wbs_audit` (
  `id` bigint(12) unsigned NOT NULL AUTO_INCREMENT,
  `noregis_id` varchar(191) DEFAULT NULL,
  `nama_auditor` varchar(191) DEFAULT NULL,
  `peran_auditor` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*Data for the table `tb_wbs_audit` */

insert  into `tb_wbs_audit`(`id`,`noregis_id`,`nama_auditor`,`peran_auditor`,`created_at`,`updated_at`) values 
(3,'RGS0010','199612232022031003','KT (Ketua Tim)','2023-09-06 10:11:19',NULL),
(4,'RGS0011','199612232022031003','PT (Pengendali Teknis)','2023-09-06 10:10:50',NULL),
(5,'RGS0011','199301212020122007','AT (Anggota Tim)','2023-09-06 10:10:41',NULL);
...
(16,'DxxROOHl','iki nama terlapor','756878','iki nama ktp','hbjnj@gmail.com','5465768','iki instansi terlapor','iki nama terlapor','iki uraian','bukti-iki-nama-terlapor-2023-08-03.jpeg','ktp-iki-nama-terlapor-2023-08-03.jpeg','1','1','1','1','2023-08-03 02:08:57','2023-08-03 02:08:57');

/*Table structure for table `tb_web_wbs_offln` */

DROP TABLE IF EXISTS `tb_web_wbs_offln`;

CREATE TABLE `tb_web_wbs_offln` (
  `id` bigint(12) unsigned NOT NULL AUTO_INCREMENT,
  `no_regis` varchar(15) DEFAULT NULL,
  `token_web` varchar(191) DEFAULT NULL,
  `no_laporan` varchar(30) DEFAULT NULL,
  `tgl_lapor` date DEFAULT NULL,
  `tgl_terima_lpr` date DEFAULT NULL,
  `perihal` varchar(191) DEFAULT NULL,
  `isi_aduan` text,
  `pendftrn_aduan` varchar(191) DEFAULT NULL,
  `jns_pelapor` varchar(191) DEFAULT NULL,
  `jns_pelapor_lain` varchar(191) DEFAULT NULL,
  `lok_kejadian` varchar(191) DEFAULT NULL,
  `wkt_kejadian` varchar(191) DEFAULT NULL,
  `ctt_petugas` text,
  `jns_potensi` varchar(191) DEFAULT NULL,
  `media_penyimpan` varchar(191) DEFAULT NULL,
...
/*Data for the table `tb_web_wbs_offln` */

insert  into `tb_web_wbs_offln`(`id`,`no_regis`,`token_web`,`no_laporan`,`tgl_lapor`,`tgl_terima_lpr`,`perihal`,`isi_aduan`,`pendftrn_aduan`,`jns_pelapor`,`jns_pelapor_lain`,`lok_kejadian`,`wkt_kejadian`,`ctt_petugas`,`jns_potensi`,`media_penyimpan`,`status`,`created_at`,`updated_at`) values 
(10,'RGS0005',NULL,'nolap2342342jajal','2023-09-01','2023-09-04','iki perihal dadi','iki isi pengaduan ftg','Tanpa Nomor  Agenda','Dugaan TPK / Berkadar Pengawasan',NULL,'iki lokasi kejadian langsung','08:04','iki catatan petugas','Non Dugaan PWKKND','Langsung','Ditindaklanjuti','2023-09-04 01:05:18','2023-09-06 03:44:10'),
(11,'RGS0006',NULL,'nolap2342342jajalerfda','2023-09-03','2023-09-04','sfdvcsadzz','ewfdvsdv','Dengan Nomor Agenda','lain-lain','iki lain lain','fbdvdf','10:03','sdfvzxc',NULL,'Tidak Langsung','Belum Ditindaklanjuti','2023-09-04 03:03:31','2023-09-04 03:03:31'),
(12,'RGS0007','OeY6O7Q4','-','2023-09-04','2023-09-04','dfgnfn','fdnfdn','-','-',NULL,'-','-','-',NULL,'Website','Belum Ditindaklanjuti','2023-09-04 03:52:54','2023-09-04 03:52:54'),
(13,'RGS0008','90emlQxF','-','2023-09-04','2023-09-04','Pengaduan Kerjaan Beton','Pengerjaan TIdak sesuai Target','-','-',NULL,'-','-','-',NULL,'Website','Belum Ditindaklanjuti','2023-09-04 07:58:10','2023-09-04 08:01:14'),
(14,'RGS0009',NULL,'nolap23489894574','2023-09-01','2023-09-04','Dugaan Tipikor','Kekurangan Pekerjaan Aliran irigasi','Dengan Nomor Agenda','Dugaan TPK / Berkadar Pengawasan',NULL,'Kecamatan Kabuh','15:09','Diduga Kekurangan Pekerjaan Karena Uang Dibawa Pak minto',NULL,'Tidak Langsung','Belum Ditindaklanjuti','2023-09-04 08:09:50','2023-09-04 08:09:50'),
(15,'RGS0010',NULL,'nolap2340987986','2023-08-28','2023-09-01','Ini pErihal','Ini Isi pengaduan (Langsung)','Dengan Nomor Agenda','Non Dugaan TPK / Tidak Berkadar Penawasan',NULL,'Kecamatan Tuban','15:16','ini catatan petugas','Dugaan PWKKND','Langsung','Belum Ditindaklanjuti','2023-09-04 08:16:55','2023-09-06 03:43:28'),
(18,'RGS0011',NULL,'nolap23423424e8798  edit333','2023-09-01','2023-09-06','jajal','yrfdguyiguhjk','Dengan Nomor Agenda','Dugaan TPK / Berkadar Pengawasan',NULL,'Kecamatan kudu','14:44','fszdxgcfhgvj','Dugaan PWKKND','Tidak Langsung','Belum Ditindaklanjuti','2023-09-06 07:44:44','2023-09-06 07:48:50');

/*Table structure for table `temp_dokumen` */

DROP TABLE IF EXISTS `temp_dokumen`;

CREATE TABLE `temp_dokumen` (
  `id` bigint(12) unsigned NOT NULL AUTO_INCREMENT,
  `noregis_id` varchar(191) DEFAULT NULL,
  `jns_dokumen` varchar(191) DEFAULT NULL,
...
/*Data for the table `temp_dokumen` */

insert  into `temp_dokumen`(`id`,`noregis_id`,`jns_dokumen`,`jumlah`,`ket`,`created_at`,`updated_at`) values 
(36,'RGS0005','1693789410506_jjal.docx',NULL,NULL,'2023-09-04 01:03:30','2023-09-04 01:03:30'),
(37,'RGS0006','1693789640903_lamaran RS Hasyim Asyari 2021.docx',NULL,NULL,'2023-09-04 01:07:20','2023-09-04 01:07:20'),
(38,'RGS0007','bukti-sadgvasv-2023-09-04.docx',NULL,NULL,'2023-09-04 03:52:54','2023-09-04 03:52:54'),
(39,'RGS0008','bukti-supardi-2023-09-04.docx',NULL,NULL,'2023-09-04 07:58:10','2023-09-04 07:58:10'),
(40,'RGS0009','1693814810647_jjal.docx',NULL,NULL,'2023-09-04 08:06:50','2023-09-04 08:06:50'),
(41,'RGS0010','1693815188377_jjal.docx',NULL,NULL,'2023-09-04 08:13:08','2023-09-04 08:13:08'),
(44,'RGS0011','1693986247511_Cuti 1 hari 17052022.docx',NULL,NULL,'2023-09-06 07:44:07','2023-09-06 07:44:07');

/*Table structure for table `temp_pelapor` */

DROP TABLE IF EXISTS `temp_pelapor`;

CREATE TABLE `temp_pelapor` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `noregis_id` varchar(191) DEFAULT NULL,
  `nama_pelapor` varchar(191) DEFAULT NULL,
  `foto_tnd_pngenal` varchar(191) DEFAULT NULL,
  `tanda_pengenal` varchar(191) DEFAULT NULL,
  `no_tnd_pengenal` varchar(100) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=latin1;

/*Data for the table `temp_pelapor` */

insert  into `temp_pelapor`(`id`,`noregis_id`,`nama_pelapor`,`foto_tnd_pngenal`,`tanda_pengenal`,`no_tnd_pengenal`,`created_at`,`updated_at`) values 
(29,'RGS0005','iki nama pelapor tidak langsung','1693789379698_27131_rev.jpg','KTP','76589656796','2023-09-04 01:02:59','2023-09-04 01:02:59'),
(30,'RGS0006','iki nama pelapor online','1693789628548_index-removebg-preview(1).png','KTP','5675685885','2023-09-04 01:07:08','2023-09-04 01:07:08'),
(31,'RGS0007','sadgvasv','ktp-sadgvasv-2023-09-04.jpg','NIK','364374357','2023-09-04 03:52:54','2023-09-04 03:52:54'),
(32,'RGS0008','Supardi','ktp-supardi-2023-09-04.png','NIK','23532523','2023-09-04 07:58:10','2023-09-04 07:58:10'),
(33,'RGS0009','Jariati','1693814796720_contoh ktp.png','NIK','9698675986','2023-09-04 08:06:36','2023-09-04 08:06:36'),
(34,'RGS0010','Darmi','1693815180372_contoh ktp.png','NIK','72569832757','2023-09-04 08:13:00','2023-09-04 08:13:00'),
(37,'RGS0011','tyjthj','1693986206579_jjal.docx','nik','576878','2023-09-06 07:43:26','2023-09-06 07:43:26'),
(38,'RGS0010','Darminto','1693987964217_contoh ktp.png','nik','34532452345','2023-09-06 08:12:44','2023-09-06 08:12:44');

/*Table structure for table `temp_terlapor` */

DROP TABLE IF EXISTS `temp_terlapor`;

CREATE TABLE `temp_terlapor` (
  `id` bigint(12) unsigned NOT NULL AUTO_INCREMENT,
  `noregis_id` varchar(191) DEFAULT NULL,
  `nama_terlapor` varchar(191) DEFAULT NULL,
...
/*Data for the table `temp_terlapor` */

insert  into `temp_terlapor`(`id`,`noregis_id`,`nama_terlapor`,`nik`,`alamat`,`jabatan`,`instansi`,`created_at`,`updated_at`) values 
(15,'RGS0005','iki nama terlapor langsung','2397425697','iki alamat erlapor langsung','iki jbatan langsung','iki instansi langsung','2023-09-04 01:04:41',NULL),
(16,'RGS0007','sadgvasv','-','-','dfgnfgn','dfnfdn','2023-09-04 03:52:54','2023-09-04 03:52:54'),
(17,'RGS0008','Supardi','-','-','Kepala Bidang','Dinas Kependudukan dan Pencatatan Sipil','2023-09-04 07:58:10','2023-09-04 07:58:10'),
(18,'RGS0009','Jarminto','8562395692857','Ds. Kabuh Kecamatan Kabuh Kabupaten Jombang','PPK','Dinas PUP','2023-09-04 08:08:19',NULL),
(19,'RGS0010','Cak Ji','049750349890','Ds. Keuphkembeng, Kec. Mojongapit Kabupaten JOmbang','KASI','Kecamatan Jatipelem','2023-09-04 08:15:00',NULL),
(23,'RGS0011','hbkjlmk','685769','c bvnbm','GCFHGVJBH','VGJBH','2023-09-06 07:44:31',NULL);
